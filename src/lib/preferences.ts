    ...
    sections: [
      {
        ...
        label: "Sport",
        options: [
          opt("soccer", "Football / Soccer", ["soccer", "fifa", "uefa"]),
    ...
    sections: [
      {
        ...
        label: "Beats",
        options: [
          opt("ai", "AI", ["ai", "openai", "anthropic", "gemini", "llm"]),
          opt("apple", "Apple", ["apple", "iphone", "ipad", "macos"]),
          opt("google", "Google", ["google", "android", "youtube"]),
    ...
    sections: [
      {
        ...
        options: [
          ...
          opt("markets", "Markets", ["stock", "s&p", "nasdaq", "dow", "crypto"]),
          opt("tech-biz", "Big tech", ["apple", "microsoft", "nvidia", "amazon", "alphabet"]),
...
export function defaultPreferences(): Preferences {
  return {
    ...
    techie: { ...emptyPref(), topics: ["ai", "apple", "security"] },
    popcorn: { ...emptyPref(), topics: ["movies", "music"] },
    stonks: { ...emptyPref(), topics: ["macro", "markets"] },
    labrat: { ...emptyPref(), topics: ["space", "health"] },
    pitch: {
      ...emptyPref(),
      leagues: ["premier-league", "champions-league"],
    },
